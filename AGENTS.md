...
- `lib/core/utils/` is the single source of truth: `AppColor`, `CustomTextstyle`, `AppString`, `AppAssets` (auto-generated by `flutter pub run flutter_assets`). Helpers (`formatTime`, `formatDate`) at `lib/core/helper/data_helper.dart`.
